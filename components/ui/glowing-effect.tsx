...
const GlowingEffect = memo(
  ({
    ...
    const checkInactiveZone = (
      ...
      return {
        isInactive: distanceFromCenter < inactiveRadius,
        center,
    ...
    const handleMove = useCallback(
      (e?: MouseEvent | { x: number; y: number }) => {
        ...
        animationFrameRef.current = requestAnimationFrame(() => {
          ...
          const { isInactive, center, rect } = checkInactiveZone(
            mouseX,
            mouseY,
            element
          );
          ...
          if (isActive) {
            updateGlowAngle(mouseX, mouseY, center, element);
          }
        });
      },
      [proximity]
